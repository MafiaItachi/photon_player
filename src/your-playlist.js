...
function revealSongs(playlistId) {
  ...
  songListContainer.innerHTML =
    '<span style="margin-left: 35%;margin-right: 6px;color: white;font-size: larger;">SONGS</span><button onclick="clearplistsong()" style="margin: 11px;height: 30px;padding: 4px;width: 33px;"><span class="material-symbols-outlined">cancel</span></button>';
